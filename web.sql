...
-- Thời gian đã tạo: Th7 09, 2020 lúc 09:03 AM
...
CREATE TABLE IF NOT EXISTS `document` (
  ...
  `phan1` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `phan2` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `phan3` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `phan4` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `malevel` varchar(7) COLLATE utf8_unicode_ci DEFAULT NULL
